...
<head>
    <title>Code coverage report for status-alert-item.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> status-alert-item.tsx</h1>
        <div class='clearfix'>
...
<a name='L104'></a><a href='#L104'>104</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">4x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { default as React, useRef } from 'react'
...
&nbsp;
  const removeAlertCallbackSubmit = <span class="fstat-no" title="function not covered" >(): void =&gt; <span class="cstat-no" title="statement not covered" >S</span>tatusAlertService.removeAlert(props.alert.id)</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        statusAlert.current?.classList.remove('is-transparent')</span>
      }),
    )
  }
&nbsp;
  const removeAlert = <span class="fstat-no" title="function not covered" >(): void =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    hideFrameId = requestAnimationFrame(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >      statusAlert.current?.classList.add('is-transparent')</span>
<span class="cstat-no" title="statement not covered" >      setTimeout(removeAlertCallbackSubmit, 800)</span>
    })
  }
&nbsp;
  React.useEffect(() =&gt; {
...
&nbsp;
    return () =&gt; {
      ...
      hideFrameId &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >window.cancelAnimationFrame(hideFrameId)</span>
