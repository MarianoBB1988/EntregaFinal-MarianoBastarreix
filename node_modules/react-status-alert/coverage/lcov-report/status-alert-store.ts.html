...
<head>
    <title>Code coverage report for status-alert-store.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> status-alert-store.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Alert } from './status-alert-item'
&nbsp;
...
&nbsp;
const statusAlertReducer = (<span class="missing-if-branch" title="if path not taken" >I</span>state: StoreState = [], action: StoreAction): StoreState =&gt; {
  switch (action.type) {
